...
describe("Part 1 - removeEmployee", () => {
  ...
  it("removes the employee so they can no longer be retrieved", () => {
    ...
    expect(registry.getEmployee("1")).toBeFalsy();
  });
...
describe("Part 1 - getEmployee", () => {
  ...
  it("returns a falsy value for a non-existent id", () => {
    expect(registry.getEmployee("999")).toBeFalsy();
  });
});
...
describe("Part 2 - calculatePayForDay", () => {
  ...
  it("returns a falsy value for a non-existent employee", () => {
    expect(registry.calculatePayForDay("999", "2025-06-15", 8)).toBeFalsy();
  });
});
...
describe("Part 3 - updateHourlyRate", () => {
  ...
  it("returns a falsy value for a non-existent employee", () => {
    expect(registry.updateHourlyRate("999", 50)).toBeFalsy();
  });
